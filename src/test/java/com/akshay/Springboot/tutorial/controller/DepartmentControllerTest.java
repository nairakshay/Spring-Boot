...
@WebMvcTest(DepartmentController.class)//Because we are using end points
class DepartmentControllerTest {
    ...
    //From Controller Layer we are calling the Service Layer. So, we are mocking service layer
    @MockBean
    ...
    void setUp() {
        department=Department.builder().departmentAddress("Ahmedabad")
                .departmentCode("IT-06").departmentName("IT").departmentId(1L).build();
    }

    @Test
    void saveDepartment() throws Exception {
        //using saveDepartment of service layer. So, we mock Service
        Department inputDepartment=Department.builder().departmentAddress("Ahmedabad")
                .departmentCode("IT-06").departmentName("IT").build();
