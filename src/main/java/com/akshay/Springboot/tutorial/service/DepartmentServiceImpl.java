...
@Service//We can know that it is a service implementation
public class DepartmentServiceImpl implements DepartmentService{
    ...
    public List<Department> fetchDepartmentList() {
        return departmentRepository.findAll();//get all the departments available
    }

    @Override
    public Department fetchDepartmentById(Long departmentId) throws DepartmentNotFoundException {
        //return departmentRepository.findById(departmentId).get();//if we don't use get it will return OPTIONAL
        //Handling Exception
